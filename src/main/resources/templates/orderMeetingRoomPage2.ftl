...
<td><div class="txtbox floatL" style="width:100px;">
    ...
    <input hidden="true" name="userId" id="userId" type="text" size="5" value="${userId}">
    ${meetingRoom.roomNo}
</div></td>
</tr>
    <tr>
...
<script type="text/javascript">
    ...
    //2把字符串格式转换为日期类
        ...
        $.post("order2",{"roomId":roomId,"userId":userId,"num":num,"reserveStartTimeDesc":reserveStartTimeDesc,"reserveEndTimeDesc":reserveEndTimeDesc},function(result){
