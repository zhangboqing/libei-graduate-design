...
<div class="wrap flex-c-c">
    <#--<form action="" method="" class="flex-c-c">-->
        ...
        <input type="userName" id="userName" name="userName" placeholder="用户名" class="ui-field" id="js-field__email"/>
        <input type="password" id="password" name="password" placeholder="密码" class="ui-field" id="js-field__pass"/>
        <button id="js-btn" class="ui-button --usr-rtn" onclick="jsMethod()"></button>
    <#--</form>-->
</div>
